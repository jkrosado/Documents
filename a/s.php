...
<?php
  ...
  $_base_utils->initialize_page_compass("Sign In");
    ...
    //only comment this line out for brief testing periods, it disables the staff check in case you need to quickly sign in and out of accounts
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <div class="www-core-container">
            ...
            <b>Welcome, <?php echo htmlspecialchars($_SESSION['siteusername']); ?>!</b><br>
            Abuse of this panel may result in account termination and revocation of staff status.
<br>
<br>
            You should not be here if:
            <ul>
                <li>You aren't an admin</li>
            </ul>
        </div>
        <div class="www-core-container">
