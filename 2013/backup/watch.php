   ...
   <div style='
      ...
      <div style='
         ...
         <div style='
            ...
            '>
            It may be copyright-protected material, preventing you from watching it on this frontend. Please watch it on YouTube <a href='http://www.youtube.com/watch?v=".$id."'>here</a>.
         </div>
      </div>
   </div>
   <div class='clear'></div>
...
foreach($userList->items as $userInfo){
    $subcount = $userInfo->statistics->subscriberCount;
    $vidcount = $userInfo->statistics->videoCount;
}
...
foreach($vidList->items as $vidInfo){
    ...
    $likeCount = $vidInfo->statistics->likeCount;
    $dislikeCount = $vidInfo->statistics->dislikeCount;
    $commentCount = $vidInfo->statistics->commentCount;
}
$totalCount = $likeCount + $dislikeCount; // for the ratio bar to compare likes to dislikes
?>
...
if (window.yt.timing) {yt.timing.tick("bf");}    </script>
 ...
 &nbsp;&nbsp;&nbsp;   <img class="icon-watch-stats-dislike" src="http://web-old.archive.org/web/20121229102009im_/http://s.ytimg.com/yts/img/pixel-vfl3z5WfW.gif" alt="Dislike"> <?php echo number_format($dislikeCount); ?>
    ...
    <div id="watch7-secondary-actions"  class="yt-uix-button-group" data-button-toggle-group="required" style="float: left!important;">
        <span >
      ...
      <div id="watch-description-content" >
        <div id="watch-description-clip">
          <p id="watch-uploader-info">
            <strong>Uploaded on <span id="eow-date" class="watch-video-date" ><?php echo $publishedAt; ?></span>
</strong>
          </p>
...
Loading...
    ...
    <div id="watch7-discussion">
      ...
      <h4>
        <a class="comments-section-see-all" href="http://web-old.archive.org/web/20121229102009/http://www.youtube.com/all_comments?v=<?php echo $id; ?>">
              <strong>All Comments</strong> (<?php echo number_format($commentCount); ?>)
  ...
  <?php
          $commentList = json_decode(file_get_contents('https://www.googleapis.com/youtube/v3/commentThreads?key=AIzaSyAedUv0vBzLglCAt6od6rMMl394nqI8nJw&textFormat=plainText&part=snippet&order=relevance&videoId='.$id.'&maxResults=8'));
   ...
   <a href='profile?id=".$item->snippet->topLevelComment->snippet->authorChannelId->value."' class='yt-user-photo ' ><span class='video-thumb ux-thumb yt-thumb-square-48 '><span class='yt-thumb-clip'><span class='yt-thumb-clip-inner'><img alt='RyanDo2000' data-thumb='http://fulptube.rocks/dynamic/pfp/default.png' src='http://fulptube.rocks/dynamic/pfp/default.png' width='48' ><span class='vertical-align'></span></span></span></span></a>
   <div class='comment-body'>
      <div class='content-container'>
         <div class='content'>
            <p class='metadata'>
               <span class='author '>
               <a href='profile?id=".htmlspecialchars($item->snippet->topLevelComment->snippet->authorChannelId->value)."' class='yt-uix-sessionlink yt-user-name ' data-sessionlink='ei=CJCpxP-xv7QCFQnbRAodKGVivw%3D%3D' dir='ltr'>".htmlspecialchars($item->snippet->topLevelComment->snippet->authorDisplayName)."</a>
               </span>
               <span class='time' dir='ltr'>
               <a dir='ltr' href='#'>
               ".htmlspecialchars($item->snippet->topLevelComment->snippet->publishedAt)."
               </a>
               </span>
            </p>
            <div class='comment-text' dir='ltr'>
               <p>".nl2br(htmlspecialchars($item->snippet->topLevelComment->snippet->textDisplay))."</p>
            </div>
         </div>
         <div class='comment-actions'>
            ...
            <span class='separator'>&middot;</span><span class='comments-rating-positive'>".number_format($item->snippet->topLevelComment->snippet->likeCount)."</span>
  ...
  <div class="watch-sidebar-section">
    <div class="watch-sidebar-body">
      <ul id="watch-related" class="video-list">
          <?php
          $videoList = json_decode(file_get_contents('https://www.googleapis.com/youtube/v3/search?part=snippet&relatedToVideoId='.$id.'&maxResults=22&type=video&key='.$api_key));
...
</span><span dir='ltr' class='title' title='".$item->snippet->title."'>".$item->snippet->title."</span><span class='stat attribution'>by <span class='yt-user-name ' dir='ltr'>".$item->snippet->channelTitle."</span></span><span class='stat alt badge'></span><span class='stat view-count'></span></a>
          </li>";
    }
    }
}?>
...
if (window.yt.timing) {yt.timing.tick("js_head");}    </script>
    ...
    <script id="js-1886910086" src="http://web-old.archive.org/web/20121229102009js_/http://s.ytimg.com/yts/jsbin/www-watch7-core-vflzdEjU1.js" data-loaded="true"></script>
