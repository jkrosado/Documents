...
$fmt_stream_map = [
	[
	"itag" => "43",
    "url" => "./dynamic/videos/".$vid."_240.mp4",
...
$main_data = array(
    ...
    "thumbnail_url" => "./dynamic/thumbs/".$vid.".png",
    "status" => "ok",
    "has_cc" => "false",
    ...
    "storyboard_spec" => "",
    "abd" => "1",
    "iurlmaxres" => "./dynamic/thumbs/".$vid.".png",
