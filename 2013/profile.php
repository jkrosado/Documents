    ...
    <body>
        <div class="www-core-container">
            ...
            if(isset($_SESSION['siteusername']) && $_SESSION['siteusername'] == $_user['username']) 
                require($_SERVER['DOCUMENT_ROOT'] . "/old/static/module/channel_customization.php");
            ?>
        </div>
        ...
        <div class="user-header-bottom">
            <ul>
                ...
                <li class="non">
                    <a href="/2013/channel_feed?n=<?php echo htmlspecialchars($_user['username']);?>">Feed</a>
                </li>
                <li class="non">
            ...
            <div class="www-user-left-fix-offset www-user-gradient-uploaded-videos">
                ...
                <div class="video-channel-video">
                    ...
                    <span class="video-info">
                        <b><a href="/2013/watch?v=<?php echo htmlspecialchars($video['rid']); ?> "><?php echo htmlspecialchars($video['title']); ?> </a></b><br>
