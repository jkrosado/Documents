...
<div id="guide">    <div id="guide-container">
    ...
    <a class="guide-item narrow-item <?php if($_SERVER['REQUEST_URI'] == "/") { echo " guide-item-selected"; } elseif($_SERVER['REQUEST_URI'] == "/index.php") { echo " guide-item-selected"; } ?>" href="/" title="Popular on FulpTube" data-channel-id="youtube">
        <span class="thumb"><span class="video-thumb ux-thumb yt-thumb-square-18 "><span class="yt-thumb-clip"><span class="yt-thumb-clip-inner"><img data-thumb="/yts/guide/popular.jpg" alt="Thumbnail" data-thumb-manual="1" src="/yts/imgbin/guide/popular.jpg" width="18"><span class="vertical-align"></span></span></span></span></span>
    ...
    <a class="guide-item " href="#" title="Sports" data-channel-id="HC7Dr1BKwqctY">
        <span class="thumb"><span class="video-thumb ux-thumb yt-thumb-square-18 "><span class="yt-thumb-clip"><span class="yt-thumb-clip-inner"><img data-thumb="//web.archive.org/web/20121230023058/http://i4.ytimg.com/li/7Dr1BKwqctY/default.jpg" alt="Thumbnail" data-thumb-manual="1" src="/yts/imgbin/guide/sports.jpg" width="18"><span class="vertical-align"></span></span></span></span></span>
      <span class="display-name">
        <span>Sports</span>
      </span>
    </a>
    ...
    <a class="guide-item " href="#" title="Gaming" data-channel-id="HChfZhJdhTqX8">
        <span class="thumb"><span class="video-thumb ux-thumb yt-thumb-square-18 "><span class="yt-thumb-clip"><span class="yt-thumb-clip-inner"><img data-thumb="//web.archive.org/web/20121230023058/http://i1.ytimg.com/li/hfZhJdhTqX8/default.jpg" alt="Thumbnail" data-thumb-manual="1" src="/yts/imgbin/guide/game.jpg" width="18"><span class="vertical-align"></span></span></span></span></span>
      <span class="display-name">
        <span>Gaming</span>
      </span>
    </a>
    ...
    <a class="guide-item " href="#" title="Movies" data-channel-id="UCczhp4wznQWonO7Pb8HQ2MQ">
        <span class="thumb"><span class="video-thumb ux-thumb yt-thumb-square-18 "><span class="yt-thumb-clip"><span class="yt-thumb-clip-inner"><img data-thumb="https://web.archive.org/web/20121230023058/http://i4.ytimg.com/i/czhp4wznQWonO7Pb8HQ2MQ/1.jpg" alt="Thumbnail" data-thumb-manual="1" src="/yts/imgbin/guide/movie.png" width="18"><span class="vertical-align"></span></span></span></span></span>
      <span class="display-name">
        <span>Movies</span>
      </span>
    </a>
    ...
    <a class="guide-item " href="#" title="TV Shows" data-channel-id="UCl8dMTqDrJQ0c8y23UBu4kQ">
        <span class="thumb"><span class="video-thumb ux-thumb yt-thumb-square-18 "><span class="yt-thumb-clip"><span class="yt-thumb-clip-inner"><img data-thumb="https://web.archive.org/web/20121230023058/http://i1.ytimg.com/i/l8dMTqDrJQ0c8y23UBu4kQ/1.jpg" alt="Thumbnail" data-thumb-manual="1" src="/yts/imgbin/guide/tv.png" width="18"><span class="vertical-align"></span></span></span></span></span>
      <span class="display-name">
        <span>TV Shows</span>
      </span>
    </a>
    ...
    <a class="guide-item " href="#" title="News" data-channel-id="HCPvDBPPFfuaM">
        <span class="thumb"><span class="video-thumb ux-thumb yt-thumb-square-18 "><span class="yt-thumb-clip"><span class="yt-thumb-clip-inner"><img data-thumb="//web.archive.org/web/20121230023058/http://i1.ytimg.com/li/PvDBPPFfuaM/default.jpg" alt="Thumbnail" data-thumb-manual="1" src="/yts/imgbin/guide/news.jpg" width="18"><span class="vertical-align"></span></span></span></span></span>
      <span class="display-name">
        <span>News</span>
      </span>
    </a>
              ...
              <li class="guide-channel">
    <a class="guide-item <?php if($_SERVER['REQUEST_URI'] == "/channel?n=Spotlight") { echo " guide-item-selected"; } ?>" href="/channel?n=Spotlight" title="Spotlight" data-channel-id="UCBR8-60-B28hp2BmDPdntcQ">
        <span class="thumb"><span class="video-thumb ux-thumb yt-thumb-square-18 "><span class="yt-thumb-clip"><span class="yt-thumb-clip-inner"><img data-thumb="https://web.archive.org/web/20121230023058/http://i2.ytimg.com/i/ULkRHBdLC5ZcEQBaL0oYHQ/1.jpg?v=50bd2bea" alt="Thumbnail" data-thumb-manual="1" src="/yts/imgbin/guide/spotlight.jpg" width="18"><span class="vertical-align"></span></span></span></span></span>
      <span class="display-name">
        <span>Spotlight</span>
      </span>
    </a>
...
Sign in to add channels to your guide and for great recommendations!
    ...
    <div id="guide-builder-promo-buttons" class="signed-out clearfix">
      <a href="/sign_in" class="yt-uix-button   yt-uix-sessionlink yt-uix-button-hh-primary" data-sessionlink="ei=CPyeyIWLwbQCFZkQIQodPx8kow%3D%3D"><span class="yt-uix-button-content">Sign in ›</span></a>
    </div>
  </div>
<?php } else { ?>
<?php
                    $acctName = $_SESSION['siteusername'];
                    $stmt = $conn->prepare("SELECT * FROM subscribers WHERE sender = ? ORDER BY id LIMIT 15");
...
<a class="guide-item <?php if($_SERVER['REQUEST_URI'] == "/channel?n=".$sub['reciever']) { echo " guide-item-selected"; } ?>" href="/channel?n=<?php echo $sub['reciever']; ?>" title="<?php echo htmlspecialchars($sub['reciever']); ?>" data-channel-id="UCBR8-60-B28hp2BmDPdntcQ">
        <span class="thumb"><span class="video-thumb ux-thumb yt-thumb-square-18 "><span class="yt-thumb-clip"><span class="yt-thumb-clip-inner"><img data-thumb="/dynamic/pfp/<?php echo "default.png"; ?>" alt="Thumbnail" data-thumb-manual="1" src="/dynamic/pfp/<?php echo $_user_fetch_utils->fetch_user_pfp($sub['reciever']); ?>" width="18"><span class="vertical-align"></span></span></span></span></span>
      <span class="display-name">
        <span><?php echo htmlspecialchars($sub['reciever']); ?></span>
      </span>
    </a>
...
<hr class="guide-section-separator">
              ...
              <li class="guide-channel">
    <a class="guide-item <?php if($_SERVER['REQUEST_URI'] == "/channels") { echo " guide-item-selected"; } ?>" href="/channels" title="Browse channels">
        <span class="thumb"><span class="video-thumb ux-thumb yt-thumb-square-18 "><span class="yt-thumb-clip"><span class="yt-thumb-clip-inner"><img alt="Thumbnail" data-thumb-manual="1" src="/static/img/guidebrowse.png" width="18"><span class="vertical-align"></span></span></span></span></span>
      <span class="display-name">
