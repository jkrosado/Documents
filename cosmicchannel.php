  ...
  <div id="branded-page-default-bg" class="ytg-base">
    ...
    <div id="channel-header-main">
      <div class="upper-section clearfix">
            ...
            ?>
        <a href="profile?id=<?php echo $_GET['n']; ?>">
...
by <span class="yt-user-name " dir="ltr"><?php echo $_user['username']; ?></span>
  ...
  <ul class="section">
                    ...
                    <span class="section-user" style="width: 100%!important; color: #000!important;" >Date Joined <span class="section-user-info" style="color: #808080!important;"><?php echo date("M d, Y", strtotime($_user['created'])); ?></span></span><br>
                    <span class="section-user" style="width: 100%!important; color: #000!important;">Latest Activity <span class="section-user-info" style="color: #808080!important;"><?php echo date("M d, Y", strtotime($_user['lastlogin'])); ?></span></span>
