...
#guide {
    ...
    <body>
        ...
        <div class="user-header-bottom">
            <ul>
                <li class="non">
                    <a href="/2013/profile?id=<?php echo htmlspecialchars($_user['username']);?>">Featured</a>
                </li>
                <li class="selected-user">
                    Feed
                </li>
                <li class="non">
                    <a href="/2013/channel_videos?n=<?php echo htmlspecialchars($_user['username']);?>">Videos</a>
                </li>
            </ul>
        </div>
        <div class="www-user-left">
            <div class="www-user-left-fix-offset">
            <table class="user-feed-table">
                <thead>
                    <tr>
                        <th style="width: 6%;">&nbsp;</th>
                        <th>&nbsp;</th>
                ...
                <tbody>
                    ...
                    ?> 
                    <tr>
                        <td class="bubble-user-icon">
                            <a href="/user/<?php echo htmlspecialchars($_user['username']); ?>">
                                <img src="/dynamic/pfp/<?php echo htmlspecialchars($_user['pfp']); ?>">   
                            </a> 
                        </td>
                        <td>
                            <b><?php echo htmlspecialchars($_user['username']); ?></b> uploaded<br><br>
                            <div class="video-feed-video">
                                <div class="video-thumbnail r185" 
                                ...
                                <span class="video-info">
                                    ...
                                    <span class="views"><?php echo $_video_fetch_utils->get_video_views($video['rid']); ?> views</span><br>
