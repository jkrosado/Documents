...
<div id="guide">    <div id="guide-container">
    ...
    <a class="guide-item narrow-item <?php if($_SERVER['REQUEST_URI'] == "/2013/") { echo " guide-item-selected"; } elseif($_SERVER['REQUEST_URI'] == "/2013/index.php") { echo " guide-item-selected"; } ?>" href="/2013" title="Popular on FulpTube" data-channel-id="youtube">
    ...
    <a class="guide-item " href="#" title="News" data-channel-id="HCPvDBPPFfuaM">
      ...
      <span class="display-name">
        <span>News</span>
              ...
              <li class="guide-channel">
    <a class="guide-item <?php if($_SERVER['REQUEST_URI'] == "/2013/profile?id=Spotlight") { echo " guide-item-selected"; } ?>" href="./profile?id=Spotlight" title="Spotlight" data-channel-id="UCBR8-60-B28hp2BmDPdntcQ">
...
Sign in to add channels to your guide and for great recommendations!
    ...
    <div id="guide-builder-promo-buttons" class="signed-out clearfix">
      <a href="/2013/sign_in" class="yt-uix-button   yt-uix-sessionlink yt-uix-button-hh-primary" data-sessionlink="ei=CPyeyIWLwbQCFZkQIQodPx8kow%3D%3D"><span class="yt-uix-button-content">Sign in ›</span></a>
    </div>
  </div>
<?php } else { ?>
<?php
...
<a class="guide-item " href="/2013/profile?id=<?php echo $sub['reciever']; ?>" title="<?php echo htmlspecialchars($sub['reciever']); ?>" data-channel-id="UCBR8-60-B28hp2BmDPdntcQ">
...
<hr class="guide-section-separator">
              ...
              <li class="guide-channel">
    <a class="guide-item <?php if($_SERVER['REQUEST_URI'] == "/2013/channels") { echo " guide-item-selected"; } ?>" href="./channels" title="Browse channels">
        <span class="thumb"><span class="video-thumb ux-thumb yt-thumb-square-18 "><span class="yt-thumb-clip"><span class="yt-thumb-clip-inner"><img alt="Thumbnail" data-thumb-manual="1" src="/2013/static/img/guidebrowse.png" width="18"><span class="vertical-align"></span></span></span></span></span>
      <span class="display-name">
