(function() {
    ...
    function Ja(a, b) {
        for (var c = 1; c < arguments.length; c++) {
            var d = arguments[c],
                e;
            if (u(d) || (e = da(d)) && Object.prototype.hasOwnProperty.call(d, "callee"))
                a.push.apply(a, d);
            else if (e)
    ...
    h.Q = function(a) {
        if (0 != this.ga)
            return this.d || (this.d = []), this.d.push(a), !1;
        var b = this.b[a];
        if (b) {
            var c = this.A[b];
            c && Ga(c, a);
    ...
    function ob(a, b) {
        ...
        if (d)
            for (var e in c)
                d = d.replace(RegExp("\\$" + e, "gi"), function() {
                    return c[e]
                });
        return d
    }
    ...
    t:
    {
        var cc = "",
            dc;
        if (Xb && p.opera)
            var ec = p.opera.version,
                cc = "function" == typeof ec ? ec() : ec;
        else if (Q ? dc = /rv\:([^\);]+)(\)|;)/ : P ? dc = /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/ : R && (dc = /WebKit\/(\S+)/), dc)
            var fc = dc.exec(Tb()),
                cc = fc ? fc[1] : "";
        if (P) {
            var gc = ac();
    ...
    function nc(a, b) {
        for (var c = mc(a), d = La(arguments, 1), e = c, f = 0; f < d.length; f++)
            F(e, d[f]) || e.push(d[f]);
        c = c.join(" ");
        a.className = c
    }
    ...
    function ed(a) {
        ...
        if (a.g != a.b.length) {
            for (var e = {}, c = b = 0; b < a.b.length;)
                d = a.b[b],
                Object.prototype.hasOwnProperty.call(e, d) || (a.b[c++] = d, e[d] = 1),
                b++;
            a.b.length = c
        }
    }
        ...
        case "object":
            ...
            if (u(b)) {
                ...
                for (var e = "", f = 0; f < d; f++)
                    c.push(e),
                    e = b[f],
                    kd(a, a.b ? a.b.call(b, String(f), e) : e, c),
                    e = ",";
                c.push("]");
                break
            }
            ...
            d = "";
            for (f in b)
                Object.prototype.hasOwnProperty.call(b, f) && (e = b[f], "function" != typeof e && (c.push(d), ld(f, c), c.push(":"),
    ...
    function ud(a, b, c, d, e, f, g) {
        ...
        if (e = vd(a, e))
            for (var l in e)
                ...
                "content-type" == l.toLowerCase() && (f = !1);
    ...
    function yd(a, b) {
        ...
        case "JSON":
            ...
            break;
        case "XML":
            if (d = (d = b.responseXML) ? zd(d) : null)
                c = {},
                D(d.getElementsByTagName("*"), function(a) {
                    c[a.tagName] = Ad(a)
                })
        }
        return c
    ...
    function Hd(a) {
        ...
        if (a.getBoundingClientRect)
            ...
            for (e = a; (e = Gd(e)) && e != c.body && e != g;)
                f.x -= e.scrollLeft,
                Xb && "TR" == e.tagName || (f.y -= e.scrollTop)
        }
        return f
    }
    function Id(a, b) {
    ...
    function V(a) {
        ...
        if ("HTML" != a.target.tagName && c) {
            ...
            if (b = Td[a.type])
                for (d in b.A)
                    (e = Vd(a.type, d, a.target)) && b.q(d, e, a.type, a)
        }
    }
    U(document, "blur", V, !0);
    ...
    function ge(a, b, c, d, e, f) {
        ...
        if (!(f == g || f && g && f.width == g.width && f.height == g.height))
            if (f = sc(uc(c)), k = yc(f.b), !P || k && S("8"))
                f = c.style,
                Q ? f.MozBoxSizing = "border-box" : R ? f.WebkitBoxSizing = "border-box" : f.boxSizing = "border-box",
                f.width = Math.max(g.width, 0) + "px",
                f.height = Math.max(g.height, 0) + "px";
            else if (f = c.style, k) {
                if (P) {
                    k = Md(c, "paddingLeft");
                    l = Md(c, "paddingRight");
                    ...
                    l = Dd(c, "paddingRight"),
                    m = Dd(c, "paddingTop"),
                    n = Dd(c, "paddingBottom"),
                    k = new Cd(parseFloat(m), parseFloat(l), parseFloat(n), parseFloat(k));
                if (!P || P && 9 <= kc)
                    l = Dd(c, "borderLeftWidth"),
                    m = Dd(c,
                    "borderRightWidth"),
                    n = Dd(c, "borderTopWidth"),
                    t = Dd(c, "borderBottomWidth"),
                    l = new Cd(parseFloat(n), parseFloat(m), parseFloat(t), parseFloat(l));
                else {
                    l = Od(c, "borderLeft");
                ...
                f.pixelWidth = g.width,
                f.pixelHeight = g.height;
        ...
        if (1 == c.nodeType) {
            ...
            N = ea(c.d),
            r = c,
            c.targetTouches ? r = c.targetTouches[0] : N && c.b.targetTouches && (r = c.b.targetTouches[0]),
            r = new O(r.clientX,
            r.clientY);
        c = Jd(d);
    ...
    function rf(a, b, c) {
        ...
        if (d) {
            ...
            e && !G(e) || nf(new xe(a, String(c), "yt.mdx.remote"))
    }
    ;
    function sf(a) {
        this.b = a
    ...
    h.clear = function() {
        for (var a = uf(this).keys, b = a.length - 1; 0 <= b; b--)
            this.remove(a[b])
    };
    function uf(a) {
    ...
    function Tg(a, b) {
        ...
        xg(Cg(), a.b.minVersion) || (a.b.disable.flash =
        !0);
        a.W || (a.W = Xg(a, a.b.args.jsapicallback || "onYouTubePlayerReady"));
        a.b.args.jsapicallback = null;
        if (c = a.b.attrs.width)
            a.H.style.width = Id(Number(c) || c, !0);
        if (c = a.b.attrs.height)
            a.H.style.height = Id(Number(c) || c, !0);
    ...
    h.O = function(a) {
        ...
        if (c)
            if (this.ba = !1, a && b.isNotServable && b.isNotServable())
                Yg(this);
            else {
                Sg(this);
                this.p = !0;
    ...
    function th(a) {
        ...
        if (0 <= b.search("MSIE") && (b = b.match(/MSIE ([\d.]+)/)[1], 0 > va(b, "10.0")))
            return a;
    ...
    Nh.prototype.add = function(a, b, c, d, e) {
        ...
        f || (f = this.b[a] = [], this.d++);
        var g = Oh(f, b, d, e);
        -1 < g ? (a = f[g], c || (a.qa = !1)) : (a = new Lh(b, this.src, a, !!d, e), a.qa = c, f.push(a));
        return a
    };
    ...
    function Oh(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.removed && f.R == b && f.capture == !!c && f.b == d)
                return e
        }
        return -1
    }
    ...
    function Yh(a, b, c, d, e) {
        if (u(b))
            ...
            (c = Uh(c), Jh(a)) ? a.$.remove(String(b), c, d, e) : a && (a = Vh(a)) && (b = a.b[b], a = -1, b && (a = Oh(b, c, !!d, e)), (c = -1 < a ? b[a] : null) && Zh(c))
    }
    function Zh(a) {
    ...
    function hi() {
        G(Tf()) && G(Vf()) || ji();
        var a;
        if (Of("yt-remote-delayed-connect-key"))
            a = !0;
        else {
            ...
            if (!g) {
                ...
                g)
                    if (a = Ee(), e.pairingCode = a, f = f.id, cg(), g = kg(f), (k = Yf()) && g) {
                        ...
                        Xf("No cast API or no cast device. Dropping cast launch.")
            }
    ...
    function ui() {
        ...
        if (d) {
            if (d = d.apply(null, [a, b, c, void 0]))
                wi(d),
                xi()
        } else {
            var d = {
            ...
            for (var l in c)
                "_" != l.charAt(0) && (d[l] = c[l]);
            c = {};
            g = [];
            l = a._start;
            for (var m in a)
                "_" != m.charAt(0) && (f = Math.max(Math.round(a[m] - l), 0), c[m] = f, g.push(m + "." + f));
            d.rt = g.join(",");
            a = {};
            m = [];
            for (var n in b)
                "_" != n.charAt(0) && (a[n] = b[n], m.push(n + "." + b[n]));
            d.it = m.join(",");
            wi(d);
    ...
    h = Ki.prototype;
    h.tb = function(a, b) {
        if (this.p && this.p != this.d.origin)
            this.dispose();
        ...
        bd(a.b.G(!0), function(a) {
            if ("bounded-collectable-storage" != a) {
                ...
                try {
                    ...
                    if ("Storage: Invalid value was encountered" == e)
                        return;
                    throw e;
                }
                b.push({
    ...
    function dj(a, b) {
        ...
        for (var c = [], d = 0, e = 0; e < b.length && d < a.length;) {
            for (var f = b[e]; d < a.length && a[d] != f;)
                c.push(a[d]),
                ++d;
            ++e
        }
    ...
    h.clear = function() {
        for (var a = this.o.XMLDocument.documentElement, b = a.attributes.length; 0 < b; b--)
    ...
    h.G = function(a) {
        var b = this.S.G(!0),
            ...
            d = new $c;
        d.next = function() {
            for (var d = b.next(); d.substr(0, c.L.length) != c.L;)
                d = b.next();
                        ...
                        if (null == k)
                            ...
                            if (k = oj()) {
                                ...
                                if (l) {
                                    ...
                                    n = pj(t ? n : null);
                                    l = l.substr(9);
                                    for (m = new Ui("d", 1); 0 > n.getTime() - f.getTime();)
                                        l += "-",
                                        n.add(m);
    ...
    z("yt.embed.openLoginDialog", function() {
        Yc(function(a) {
            if (gi.onLoginDialogSuccess)
                gi.onLoginDialogSuccess(a)
        })
    });
