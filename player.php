...
?>
<?php
    $stmt = $conn->prepare("SELECT title, author, duration FROM videos WHERE rid = ? ORDER BY id DESC");
...
$image = "/dynamic/thumbs/" . $_GET['v'] . ".png"; // set this for thumbnail
$name = $_video_fetch_utils->get_video_value($_GET['v'],"title"); // self-explanatory
?>
...
Advertisement
  ...
  <script>
    yt.setMsg({
      ...
      yt.setConfig({
      'PLAYER_CONFIG': {"assets": {"html": "\/html5_player_template", "css": "https:\/\/web.archive.org\/web\/20120609184833\/http:\/\/s.ytimg.com\/yt\/cssbin\/www-player-vflFpAOf-.css", "js": "https:\/\/web.archive.org\/web\/20120609184833\/http:\/\/s.ytimg.com\/yt\/jsbin\/html5player-vfljIEiND.js"}, "url": "https:\/\/web.archive.org\/web\/20120609184833\/http:\/\/s.ytimg.com\/yt\/swfbin\/watch_as3-vflpp9opi.swf", "min_version": "8.0.0", "args": {"el": "embedded", "fexp": "900064,907217,907335,921602,919306,919316,912804,913542,919324,912706", "is_html5_mobile_device": false, "length_seconds": <?php echo $_video_fetch_utils->get_video_value($_GET['v'],"duration"); ?>, "allow_embed": 1, "tabsb": "1", "allow_ratings": 0, "hl": "en_US", "eurl": "https:\/\/web.archive.org\/web\/20120609184833\/http:\/\/www.dailykos.com\/story\/2012\/05\/28\/1095455\/-How-to-deal-with-random-people-harassing-you-online", "iurl": "<?php echo $image; ?>", "view_count": 62280066, "title": "<?php echo $_video_fetch_utils->get_video_value($_GET['v'],'title'); ?>", "avg_rating": 4.47379109953, "video_id": "<?php echo $vid; ?>", "sw": "1.0", "enablejsapi": "0", "sk": "MvZbizDv2TLFXP_7GPrvTX347OtEerznC", "advideo": "1", "rel": "1", "playlist_module": "https:\/\/web.archive.org\/web\/20120609184833\/http:\/\/s.ytimg.com\/yt\/swfbin\/playlist_module-vfl3lol2H.swf"}, "url_v9as2": "https:\/\/web.archive.org\/web\/20120609184833\/http:\/\/s.ytimg.com\/yt\/swfbin\/cps-vflNmVqFE.swf", "params": {"allowscriptaccess": "always", "allowfullscreen": "true", "bgcolor": "#000000"}, "attrs": {"width": "100%", "id": "video-player", "height": "100%"}, "url_v8": "https:\/\/web.archive.org\/web\/20120609184833\/http:\/\/s.ytimg.com\/yt\/swfbin\/cps-vflNmVqFE.swf", "html5": true},
