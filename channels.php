...
?>
<div id="content">
<title>Browse Channels - FulpTube</title>
...
<a href="/channel?n=<?php echo htmlspecialchars($chnls['username']); ?>" style="display: flex;margin: 10px; width: 191px!important;"><img src="/dynamic/pfp/<?php echo htmlspecialchars($chnls['pfp']); ?>" height="60" width="60"><div class="channels-info" style="padding-left: 10px;"><span dir="ltr" class="title" style="font-weight: bold;color: black;font-size: 13px;display: block;margin-bottom: 2px;"><?php echo htmlspecialchars($chnls['username']); ?><?php
$_user = $_user_fetch_utils->fetch_user_username($chnls['username']);
if($_user['partner'] == "y") {
...
?></span><span dir="ltr" class="title" style="color: #999;font-size: 11px;"><?php echo $_user_fetch_utils->fetch_subs_count($chnls['username']); ?> subscribers</span></div></a>
