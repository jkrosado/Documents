        ...
        <div class="www-core-container" style="height: 2034px;">
            ...
            <div class="www-home-left">
                ...
                <div class="home-topright-header">
                    <img src="/static/img/guide.png" class="guide-topic"> <span style="padding: 5px;">Travel & Events</span>
                </div>
                <div class="featured-left-panel">
                    <ul>
                        ...
                        <li class="active" onclick="window.location.pathname = '/old/category/6/';">
                ...
                <div class="feed-homepage">
                    <?php
                        $stmt = $conn->prepare("SELECT rid, title, thumbnail, duration, title, author, publish, description FROM videos WHERE category = 'Travel & Events' ORDER BY id DESC LIMIT 20");
                        $stmt->execute();
